"""pytest configuration for godot-agent tests."""
import sys
import tempfile
import shutil
...
# Add workspace paths so imports resolve during local test runs
ROOT = Path(__file__).parent.parent  # packages/godot-agent/
WORKSPACE = ROOT.parent.parent       # repo root
