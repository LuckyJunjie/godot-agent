...
- [x] Config: pydantic 配置模块 (GodotConfig/AssetsConfig/HarnessConfig)
...
- [x] A2-impl: 图像/音频/模型生成 CLI 实现
- [ ] H1-enhance: GDD 双向同步
- [ ] A1-enhance: 完整 Asset Pipeline (LLM API 调用)

## Phase 2: 增强功能 (P1) — 进行中

### 2.1 模板与技能
- [x] Godogen YAML skill 模板 (state_machine, component, ui_screen, input_map, animation_tree)
- [x] GDScript 代码模板 (character_body_2d, component, autoload, test_gut)
- [x] Scene 模板 (character_2d, ui_screen)
- [ ] nanobot Agent Loop 集成桥接
